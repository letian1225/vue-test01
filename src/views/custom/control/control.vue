  ...
  <div>
    ...
    <div class="page-body">
      ...
      <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" style="width: 100%" max-height="750">
        <el-table-column prop="wfw_name_ch" label="控件中文名称">
        </el-table-column>
        <el-table-column prop="wfw_name" label="控件英文名称">
        </el-table-column>
        <el-table-column prop="wfw_icon" label="控件ICON">
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button @click.native.prevent="editRowJson(scope.$index, tableData)" @click="dialogEditJsonVisible = true" size="mini">
              编辑
            </el-button>
            <el-button @click.native.prevent="showRowJson(scope.$index, tableData)" @click="dialogShowJsonVisible = true" type="info" size="mini">
              结构
            </el-button>
          </template>
        </el-table-column>
      ...
      <el-dialog title="新建控件" :visible.sync="dialogAddJsonVisible">
        ...
        <el-form ref="newControlForm" :rules="newControlJsonRules" :model="newControlJson" label-width="120px">
          ...
          <el-form-item>
            <el-button size="small" type="primary" @click="onControlSubmit('newControlForm')">立即创建</el-button>
            <el-button size="small" type="warning" @click="onAddControlSubmit">新增属性</el-button>
            <el-button size="small" @click="onResetControlSubmit('newControlForm'), dialogAddJsonVisible = false">取消</el-button>
          </el-form-item>
        </el-form>
      </el-dialog>
      ...
      <el-dialog title="编辑属性" :visible.sync="dialogEditJsonVisible">
        ...
        <el-form ref="form" :model="rowJson" label-width="120px">
          ...
          <el-form-item>
            <el-button size="small" type="primary" @click="onEditControlSubmit">立即保存</el-button>
            <el-button size="small" @click="reload(),dialogEditJsonVisible = false">取消</el-button>
          </el-form-item>
        </el-form>
