...
export default {
  ...
  methods: {
    ...
    listWfForms(){
      ...
      if(wff_id !== undefined){
        ...
        if(wff_id == 0){
          ...
          Vue.http.jsonp(this.URL+"Forms/listWfForms",{params: { wff_id: wff_id}})
             .then((res) => {
    ...
    getWfFormByID(wff_id){
      Vue.http.jsonp(this.URL+"Forms/getWfFormByID",{params: { wff_id: wff_id}})
         .then((res) => {
    ...
    //编辑、新建表单
    editWfForms(wff_id){
      Vue.http.post(this.URL+"Forms/editWfForms",{
          wff_id: wff_id,
        ...
        if(res.data.errorCode == 1){
          ...
          if(wff_id == 0){
            this.$router.push('/custom/form/form')
          }
        }else{
...
<style scoped lang="less">
  ...
  .form-header{height: 60px; width: 100%; position: fixed; left: 0; top:0; background-color: #f2f2f2; padding: 8px 10px; box-sizing: border-box; z-index: 1001;}
  .controls-list{width: 300px; height:calc(~"100% - 60px"); position: fixed; left: 0; top:60px;background-color: #fff;  border-right: 1px solid #e6e6e6; 
    h3{font-size: 16px; padding: 0 10px; height: 50px; line-height: 50px; font-weight: normal; margin: 0; border-bottom: 1px solid #e6e6e6; background-color: #fff; color: #333;}
    .vddl-list{ width: 100%;
      .vddl-draggable{width: 33.333%; height: 102px; cursor: move; display: inline-block;  text-align: center; padding: 10px; box-sizing: border-box; border-bottom: 1px solid #e6e6e6;
  ...
  .attribute{width:500px; height: calc(~"100% - 60px"); border-left: 1px solid #e6e6e6;  background: #fff; position: fixed; right: 0; top:60px; overflow: auto;
    ...
    .attr-item{width: 100%;.clearfix; border-bottom: 1px solid #e6e6e6; font-size: 14px;  position: relative;
      ...
      .edit-text{width: calc(~"100% - 150px"); line-height: 30px; float: left; margin-left: 150px; padding: 0 10px; color: #999; box-sizing: border-box; border-left: 1px solid #e6e6e6;
        input[type='text'], input[type='number']{width: 100%; height: 100%; border:0;
          &:focus{outline: 0;}
        }
